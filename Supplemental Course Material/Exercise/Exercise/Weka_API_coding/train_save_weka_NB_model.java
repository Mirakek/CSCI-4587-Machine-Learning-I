...
public class train_save_weka_NB_model{
     ...
     public static void main (String[] args) throws Exception{
          ...
          /* sets the file to use for training */
             ...
             NaiveBayes nb = new NaiveBayes();   //Create an NaiveBayes Object

             
             nb.buildClassifier(Train);          //Train the model

             weka.core.SerializationHelper.write("saved_nb_model",nb); // Save the model in a file to be loaded and used later
